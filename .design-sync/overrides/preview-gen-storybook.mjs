...
export function generatePreviewSource(c, opts) {
  ...
  const imports = [...modVars.entries()]
    ...
    .join('\n');
  // FORK: cada preview importa el chrome de las tarjetas, para renderizar sobre
  // el mismo canvas oscuro que Storybook. Compila a _preview/<Name>.css (necesita
  // cfg.storyImports.loaders {".css": "css"}), que emit.mjs enlaza solo; queda
  // fuera del cierre de styles.css, asi que nunca llega a los disenos.
  return `import * as React from 'react';
import '@ds-stories/.design-sync/preview-chrome.css';
${imports}
